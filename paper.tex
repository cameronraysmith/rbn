...
at least one fixed point.  Furthermore, in the case where the cycle
contains a single fixed point (such as in the Volterra-Lotke model of
...
components.  Hence, our weighted average becomes
\begin{equation}
R(\hbox{avg stab} C_i, m) =
\frac{sum_{m_0, m_1, \ldots m_n} {m \choose m_0, m_1, \ldots. m_n}
      m_0 + \sum_{i=1}^n m_i C_i}
     {}
\end{equation}
